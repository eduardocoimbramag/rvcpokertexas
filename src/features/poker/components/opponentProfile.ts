...
export const ACHIEVEMENTS: readonly Achievement[] = [
  {
    ...
    description: 'Venceu o primeiro duelo.',
    rarity: 'comum',
  },
  {
    id: 'streak-5',
  ...
  },
  {
    ...
    icon: 'coins',
    name: 'Alto apostador',
    description: 'Apostou 1000 créditos numa rodada.',
    rarity: 'raro',
  },
  {
    id: 'lucky-seven',
  ...
  },
  {
    ...
    icon: 'bolt',
    name: 'Virada',
    description: 'Venceu após 3 derrotas.',
    rarity: 'épico',
  },
  {
    id: 'duelist',
    icon: 'swords',
    name: 'Duelista',
    description: '100 duelos disputados.',
    rarity: 'raro',
  },
  {
    id: 'champion',
  ...
  },
  {
    ...
    icon: 'crown',
    name: 'Realeza',
    description: 'Chegou ao topo do ranking.',
    rarity: 'lendário',
  },
  {
    id: 'sharp-eye',
    icon: 'target',
    name: 'Mira certeira',
    description: 'Ganhou 20 vezes no detalhe.',
    rarity: 'raro',
  },
  {
    id: 'night-owl',
    icon: 'moon',
    name: 'Coruja',
    description: 'Jogou de madrugada 50 vezes.',
    rarity: 'comum',
  },
  {
    id: 'diamond',
    icon: 'gem',
    name: 'Diamante',
    description: 'Rating acima de 1600.',
    rarity: 'lendário',
  },
  {
    id: 'phoenix',
    icon: 'feather',
    name: 'Fênix',
    description: 'Renasceu de 10 derrotas.',
    rarity: 'épico',
  },
];
